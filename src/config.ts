...
const settingsSchema = z.object({
  ...
  provider: z.enum(["anthropic", "openai", "moonshot", "ollama"]).default("anthropic"),
...
const hasLLM = !!env.ANTHROPIC_API_KEY || settings.provider === "openai" || !!process.env.MOONSHOT_API_KEY || !!process.env.OLLAMA_BASE_URL;
