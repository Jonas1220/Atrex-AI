...
echo ""
echo -e "  1. Run the onboarding wizard:  ${AMBER}atrex setup${RESET}"
echo -e "     ${DIM}Asks for your Telegram token and AI provider key right in the terminal.${RESET}"
echo ""
echo -e "  2. Check status:               ${AMBER}atrex status${RESET}"
echo ""
echo -e "  ${DIM}Optional: open the dashboard for advanced config (plugins, soul, skills):${RESET}"
echo -e "  ${DIM}  Local:  ${RESET}atrex open"
echo -e "  ${DIM}  VPS:    ssh -L ${PORT}:localhost:${PORT} user@host${RESET}"
echo ""
